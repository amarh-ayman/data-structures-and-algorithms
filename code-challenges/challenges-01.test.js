...
const speaker = (words, callback) => {
  // Solution code here...
  let arr02 = [];
  words.forEach((item) => arr02.push(callback(item)));
  return arr02;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
const createList = (availableItems) => {
  ...
  availableItems.forEach((item) => {
    if (item["available"] === true) arr02.push(item["name"]);
  });
  return arr02;
};
...
const fizzbuzz = (arr) => {
  ...
  let arr02 = [];
  arr.forEach((item) => {
    if (item % 3 === 0 && item % 5 !== 0) arr02.push("Fizz");
    else if (item % 5 === 0 && item % 3 !== 0) arr02.push("Buzz");
    else if (item % 5 === 0 && item % 3 === 0) arr02.push("Fizz Buzz");
    else arr02.push(item);
  });
  return arr02;
};
