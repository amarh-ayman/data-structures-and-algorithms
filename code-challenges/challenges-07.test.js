...
const forLoopTwoToThe = (arr) => {
  // Solution code here...
  let arr02 = arr.map((item) => Math.pow(2, item));
  return arr02;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let arr02 = [];
  arr.forEach((item) => arr02.push(Math.pow(2, item)));
  return arr02;
};
...
const charCode = (arr) => {
  // Solution code here...
  let arr02 = arr.map((item) => item.charCodeAt());
  return arr02;
};
...
const evenOdd = (arr) => {
  ...
  let arr02 = arr.map((item) =>
    item % 2 === 0 ? "even" : typeof item === "number" ? "odd" : "N/A"
  );
  return arr02;
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  let arr02 = arr.map((item) => item.ability.name);
  return arr02;
};
