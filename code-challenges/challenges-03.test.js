...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  let arr02 = [];
  arr.forEach((element) => arr02.push(callback(element)));
  return arr02;
};
...
const sortNumbers = (arr) => {
  // Solution code here...
  return arr.sort((cur, next) => cur - next);
};
...
const sortBackwards = (arr) => {
  // Solution code here...
  return arr.sort((cur, next) => next - cur);
};
...
const sortByPrice = (arr) => {
  // Solution code here...
  return arr.sort((cur, next) => cur.price - next.price);
};
...
const alphabetizeBetter = (arr) => {
  ...
  return arr.sort((cur, next) =>
    cur.toLowerCase() < next.toLowerCase() ? -1 : 1
  );
};
...
const sortByLength = (arr) => {
  // Solution code here...
  return arr.sort((cur, next) => cur.length - next.length);
};
...
const sortNumbersByLength = (arr) => {
  // Solution code here...
  return arr.sort((cur, next) => String(cur).length - String(next).length);
};
...
const sortPeople = (arr) => {
  // Solution code here...
  return arr.sort((cur, next) => (cur.lastName > next.lastName ? 1 : -1));
};
...
const sortMeetingsByDay = (arr) => {
  // Solution code here...
  let x = { Monday: 1, Tuesday: 2, Wednesday: 3, Friday: 4 };
  return arr.sort((cur, next) => x[cur.dayOfWeek] - x[next.dayOfWeek]);
};
...
const sortSchedule = (arr) => {
  ...
  let x = { Monday: 1, Tuesday: 2, Wednesday: 3, Friday: 4 };
  return arr.sort((cur, next) => {
    if (cur.dayOfWeek !== next.dayOfWeek) x[cur.dayOfWeek] - x[next.dayOfWeek];
    else if (
      Number(cur.end) - Number(cur.start) >
